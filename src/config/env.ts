...
export const env = {
  ...
  RENT_SCORE_REQUEST_AMOUNT_NGN: Number(process.env.RENT_SCORE_REQUEST_AMOUNT_NGN ?? 5000),
  RENT_SCORE_MANUAL_BANK_NAME: process.env.RENT_SCORE_MANUAL_BANK_NAME ?? "",
  RENT_SCORE_MANUAL_ACCOUNT_NAME: process.env.RENT_SCORE_MANUAL_ACCOUNT_NAME ?? "",
  RENT_SCORE_MANUAL_ACCOUNT_NUMBER: process.env.RENT_SCORE_MANUAL_ACCOUNT_NUMBER ?? "",
  RENT_SCORE_MANUAL_INSTRUCTIONS: process.env.RENT_SCORE_MANUAL_INSTRUCTIONS ?? "",
